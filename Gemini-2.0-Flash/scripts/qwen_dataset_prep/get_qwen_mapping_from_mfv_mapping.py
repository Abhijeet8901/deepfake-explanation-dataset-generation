...
OUTPUT_BASE_PATH = Path("/media/main/Data/Abhijeet/Explanation_Dataset_Generation/Gemini-2.0-Flash/Qwen Mappings/full_dataset")
OUTPUT_PATH = OUTPUT_BASE_PATH / ("qwen_" + FILE_NAME)
...
real_image_mappings = []
REAL_IMAGES_BASE_PATH = Path("/home/paru0005/rb56_scratch/paru0005/MultiFakeVerse/real_images")
