...
from Explanation_Dataset_Generation.Prompts.edit_instruction_generation_prompts import GEMINI_PROMPTS
from dotenv import load_dotenv

env_path = Path(__file__).resolve().parents[4] / ".env"
load_dotenv(dotenv_path=env_path)

client = genai.Client(api_key=os.getenv("GOOGLE_GENAI_OPENDAY_API_KEY"))
...
async def get_edit_instructions_async(real_img: Image.Image, prompt_name: str = "gemini_prompt_mark_1"
) -> dict:
